...
class RichTextMeasureTest {
    ...
    void knownWidthWinsAndWraps() {
        FloatSize size = measureOf("hello world").measure(
            new FloatSize(60, Float.NaN),
    ...
    void emptyTextMeasuresZero() {
        FloatSize size = measure(
            new RichTextMeasure(RichText.empty(), TestTextEnvs.layouter()),
