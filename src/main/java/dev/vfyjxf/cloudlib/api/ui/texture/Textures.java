...
public final class Textures {
     ...
     */
    public static UITexture sprite(ResourceLocation spriteLocation) {
     ...
     */
    public static UITexture composite(UITexture... layers) {
        return (graphics, x, y, width, height) -> {
            for (UITexture layer : layers) {
     ...
     */
    public static UITexture tinted(UITexture texture, int argb) {
        return (graphics, x, y, width, height) -> {
     ...
     */
    public static UITexture tinted(UITexture texture, IntSupplier colorSupplier) {
        return (graphics, x, y, width, height) -> {
     ...
     */
    public static UITexture clipped(UITexture texture, int clipLeft, int clipTop, int clipRight, int clipBottom) {
        return (graphics, x, y, width, height) -> {
     ...
     */
    public static UITexture offset(UITexture texture, int offsetX, int offsetY) {
        return (graphics, x, y, width, height) ->
     ...
     */
    public static UITexture padded(UITexture texture, int padding) {
     ...
     */
    public static UITexture padded(UITexture texture, int top, int bottom, int left, int right) {
        return (graphics, x, y, width, height) -> {
     ...
     */
    public static UITexture conditional(UITexture texture, Supplier<Boolean> condition) {
        return (graphics, x, y, width, height) -> {
            if (condition.get()) {
                texture.render(graphics, x, y, width, height);
            }
     ...
     */
    public static SizedTexture sized(UITexture texture, int width, int height) {
