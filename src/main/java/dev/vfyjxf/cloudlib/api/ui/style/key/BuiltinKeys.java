...
public class BuiltinKeys {
    ...
    private static StyleKey<VisualTexture> textureKey(String id, StyleApply<VisualTexture> applier) {
        return key(
                ...
                (values, ctx) -> {
                    ComponentValue v = CssEnums.single(values);
                    VisualTexture t = v == null ? null : CssTextures.texture(v);
    ...
    public static final StyleKey<TaffyDisplay> display =
            enumKey("display", TaffyDisplay.class, CssEnums.display, (ctx, v) -> ctx.layoutStyle().display = v);

    public static final StyleKey<TaffyPosition> position =
            enumKey("position", TaffyPosition.class, CssEnums.position, (ctx, v) -> ctx.layoutStyle().position = v);

    public static final StyleKey<Overflow> overflowX =
            enumKey("overflow-x", Overflow.class, CssEnums.overflow, StyleApplies.point(s -> s.overflow, true));

    public static final StyleKey<Overflow> overflowY =
            enumKey("overflow-y", Overflow.class, CssEnums.overflow, StyleApplies.point(s -> s.overflow, false));
    ...
    public static final StyleKey<BoxSizing> boxSizing =
            enumKey("box-sizing", BoxSizing.class, CssEnums.boxSizing, (ctx, v) -> ctx.layoutStyle().boxSizing = v);

    public static final StyleKey<TaffyDirection> direction = enumKey(
            "direction", TaffyDirection.class, CssEnums.direction, true, (ctx, v) -> ctx.layoutStyle().direction = v);
    ...
    public static final StyleKey<TaffyDimension> minWidth =
            dimKey("min-width", StyleApplies.size(s -> s.minSize, true));

    public static final StyleKey<TaffyDimension> minHeight =
            dimKey("min-height", StyleApplies.size(s -> s.minSize, false));

    public static final StyleKey<TaffyDimension> maxWidth =
            dimKey("max-width", StyleApplies.size(s -> s.maxSize, true));

    public static final StyleKey<TaffyDimension> maxHeight =
            dimKey("max-height", StyleApplies.size(s -> s.maxSize, false));
    ...
    public static final StyleKey<LengthPercentageAuto> insetTop =
            lpaKey("inset-top", StyleApplies.edge(s -> s.inset, Edge.top));
    public static final StyleKey<LengthPercentageAuto> insetRight =
            lpaKey("inset-right", StyleApplies.edge(s -> s.inset, Edge.right));
    public static final StyleKey<LengthPercentageAuto> insetBottom =
            lpaKey("inset-bottom", StyleApplies.edge(s -> s.inset, Edge.bottom));
    public static final StyleKey<LengthPercentageAuto> insetLeft =
            lpaKey("inset-left", StyleApplies.edge(s -> s.inset, Edge.left));

    public static final StyleKey<LengthPercentageAuto> marginTop =
            lpaKey("margin-top", StyleApplies.edge(s -> s.margin, Edge.top));
    public static final StyleKey<LengthPercentageAuto> marginRight =
            lpaKey("margin-right", StyleApplies.edge(s -> s.margin, Edge.right));
    public static final StyleKey<LengthPercentageAuto> marginBottom =
            lpaKey("margin-bottom", StyleApplies.edge(s -> s.margin, Edge.bottom));
    public static final StyleKey<LengthPercentageAuto> marginLeft =
            lpaKey("margin-left", StyleApplies.edge(s -> s.margin, Edge.left));

    public static final StyleKey<LengthPercentage> paddingTop =
            lpKey("padding-top", StyleApplies.edge(s -> s.padding, Edge.top));
    public static final StyleKey<LengthPercentage> paddingRight =
            lpKey("padding-right", StyleApplies.edge(s -> s.padding, Edge.right));
    public static final StyleKey<LengthPercentage> paddingBottom =
            lpKey("padding-bottom", StyleApplies.edge(s -> s.padding, Edge.bottom));
    public static final StyleKey<LengthPercentage> paddingLeft =
            lpKey("padding-left", StyleApplies.edge(s -> s.padding, Edge.left));

    public static final StyleKey<LengthPercentage> borderTopWidth =
            lpKey("border-top-width", StyleApplies.edge(s -> s.border, Edge.top));
    public static final StyleKey<LengthPercentage> borderRightWidth =
            lpKey("border-right-width", StyleApplies.edge(s -> s.border, Edge.right));
    public static final StyleKey<LengthPercentage> borderBottomWidth =
            lpKey("border-bottom-width", StyleApplies.edge(s -> s.border, Edge.bottom));
    public static final StyleKey<LengthPercentage> borderLeftWidth =
            lpKey("border-left-width", StyleApplies.edge(s -> s.border, Edge.left));
    ...
    public static final StyleKey<FlexWrap> flexWrap =
            enumKey("flex-wrap", FlexWrap.class, CssEnums.flexWrap, (ctx, v) -> ctx.layoutStyle().flexWrap = v);
    ...
    public static final StyleKey<AlignItems> alignItems =
            enumKey("align-items", AlignItems.class, CssEnums.alignItems, (ctx, v) -> ctx.layoutStyle().alignItems = v);

    public static final StyleKey<AlignItems> alignSelf =
            enumKey("align-self", AlignItems.class, CssEnums.alignItems, (ctx, v) -> ctx.layoutStyle().alignSelf = v);

    public static final StyleKey<AlignItems> justifyItems = enumKey(
            "justify-items", AlignItems.class, CssEnums.alignItems, (ctx, v) -> ctx.layoutStyle().justifyItems = v);

    public static final StyleKey<AlignItems> justifySelf = enumKey(
            "justify-self", AlignItems.class, CssEnums.alignItems, (ctx, v) -> ctx.layoutStyle().justifySelf = v);

    public static final StyleKey<AlignContent> alignContent = enumKey(
            "align-content", AlignContent.class, CssEnums.alignContent, (ctx, v) -> ctx.layoutStyle().alignContent = v);
    ...
    public static final StyleKey<TextAlign> textAlign = enumKey(
            "text-align", TextAlign.class, CssEnums.textAlign, true, (ctx, v) -> ctx.layoutStyle().textAlign = v);
    ...
    public static final StyleKey<List<TrackSizingFunction>> gridTemplateRows =
            listKey("grid-template-rows", (ctx, v) -> ctx.layoutStyle().gridTemplateRows = v);

    public static final StyleKey<List<TrackSizingFunction>> gridTemplateColumns =
            listKey("grid-template-columns", (ctx, v) -> ctx.layoutStyle().gridTemplateColumns = v);

    public static final StyleKey<List<GridTemplateComponent>> gridTemplateRowsWithRepeat =
    ...
    public static final StyleKey<List<GridTemplateComponent>> gridTemplateColumnsWithRepeat = listKey(
            "grid-template-columns-with-repeat", (ctx, v) -> ctx.layoutStyle().gridTemplateColumnsWithRepeat = v);

    public static final StyleKey<List<GridTemplateArea>> gridTemplateAreas =
            listKey("grid-template-areas", (ctx, v) -> ctx.layoutStyle().gridTemplateAreas = v);

    public static final StyleKey<List<NamedGridLine>> gridTemplateColumnNames =
            listKey("grid-template-column-names", (ctx, v) -> ctx.layoutStyle().gridTemplateColumnNames = v);

    public static final StyleKey<List<NamedGridLine>> gridTemplateRowNames =
            listKey("grid-template-row-names", (ctx, v) -> ctx.layoutStyle().gridTemplateRowNames = v);

    public static final StyleKey<List<TrackSizingFunction>> gridAutoRows =
            listKey("grid-auto-rows", (ctx, v) -> ctx.layoutStyle().gridAutoRows = v);

    public static final StyleKey<List<TrackSizingFunction>> gridAutoColumns =
    ...
    public static final StyleKey<VisualTexture> background = key(
            ...
            (values, ctx) -> {
                ...
                VisualTexture t = CssTextures.texture(v);
                if (t != null) return t;
                Integer c = CssValues.color(v);
    ...
    public static final StyleKey<Integer> backgroundColor =
            colorKey("background-color", false, (ctx, v) -> ctx.visualContext().setBackground(new ColorTexture(v)));
    ...
    public static final StyleKey<Float> opacity =
            floatKey("opacity", StyleScope.custom, StyleApplies.customProp("opacity"));
     ...
     */
    public static final StyleKey<Float> borderThickness =
            floatKey("border-thickness", StyleScope.visual, StyleApplies.borderWidth);
     ...
     */
    public static final StyleKey<Boolean> textShadow = track(new StyleKey<>(
            "text-shadow",
            Boolean.class,
            StyleScope.visual,
            true,
    ...
    public static final StyleKey<ScrollbarStyleData> scrollbarStyle = key(
            ...
            (values, ctx) -> {
                ...
                List<ComponentValue> args = fn.args().stream()
                        ...
                        .toList();
                VisualTexture track = args.size() > 0 ? CssTextures.texture(args.get(0)) : null;
                VisualTexture thumb = args.size() > 1 ? CssTextures.texture(args.get(1)) : null;
    ...
    public static final StyleKey<VisualTexture> borderTexture =
            textureKey("border-texture", StyleApplies.customProp("border-texture"));
    ...
    private static <T> void edgePair(
            String name, StyleKey<T> a, StyleKey<T> b, Function<ComponentValue, @Nullable T> convert) {
        shorthand(name, (values, ctx) -> {
            ComponentValue v = CssEnums.single(values);
            if (v == null) return null;
            T t = convert.apply(v);
    ...
    private static <T> void sizePair(
            String name, StyleKey<T> width, StyleKey<T> height, Function<ComponentValue, @Nullable T> convert) {
        shorthand(name, (values, ctx) -> {
            List<ComponentValue> flat = CssEnums.flat(values);
            if (flat.isEmpty() || flat.size() > 2) return null;
