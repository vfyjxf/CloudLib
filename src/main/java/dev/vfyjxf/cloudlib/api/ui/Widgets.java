...
public final class Widgets {
    ...
    public static <T extends Widget> WidgetGroup<T> grid() {
        WidgetGroup<T> widget = new WidgetGroup<>();
        UIStyle style = UIStyle.of(displayGrid());
        widget.useStyle(style);
        throw new UnsupportedOperationException("Not Implemented");
    }

    public static <T extends Widget> WidgetGroup<T> group(UIStyle style) {
        WidgetGroup<T> widget = new WidgetGroup<>();
        widget.useStyle(style);
        return widget;
    }

    public static Widget button(UIStyle style, InputEvent.OnMouseClick onClick) {
