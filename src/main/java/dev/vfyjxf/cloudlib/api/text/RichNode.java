 ...
 * @see RichText
 */
public sealed interface RichNode permits TextNode, ComponentNode, TranslatableNode, ImageNode, ItemNode, BlockNode,
        EntityNode, WidgetNode, SpacerNode, BreakNode, CustomRenderNode, GroupNode, StyledNode {
