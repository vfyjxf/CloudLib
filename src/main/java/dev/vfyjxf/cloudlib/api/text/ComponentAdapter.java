...
public final class ComponentAdapter {
    ...
    public static MutableComponent toComponent(RichNode node) {
        return switch (node) {
            ...
            case TranslatableNode translatable -> Component.translatable(
                    translatable.key(), convertArgs(translatable.args()));
            ...
            case StyledNode styled -> Component.empty()
                    .withStyle(styled.style().style())
                    .append(toComponent(styled.child()));
