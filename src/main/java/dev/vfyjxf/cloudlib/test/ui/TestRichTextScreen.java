...
public class TestRichTextScreen extends BasicScreen {
    ...
    public TestRichTextScreen() {
        var scroll = ScrollState.create(ScrollDirection.vertical)
                                .scrollSpeed(14)
                                .smooth(true)
                                .smoothSpeed(0.35f)
                                .trackTexture(new ColorTexture(0x60000000))
                                .thumbTexture(new ColorTexture(0xCC7777DD))
                                .scrollbarWidth(5);

        var column = ColumnWidget.create(10);
        column.useStyle(UIStyle.of(
                flexGrow(1),
                minHeight(0),
                padding(14),
                background(new ColorTexture(0xC0101014))
        ));
    ...
    private Widget header() {
        var title = RichTextWidget.of(
                RichText.builder()
                        .shadow(true)
                        .text("✦ ").color(0xFF55FFFF)
                        .text("CloudLib Rich Text").color(0xFFFFAA00).bold()
                        .text(" ✦").color(0xFF55FFFF)
                        .clearStyle()
                        .build()
        );
        title.useStyle(UIStyle.of(
                UIStyles.alignSelfStretch(),
                textAlign(dev.vfyjxf.taffy.style.TextAlign.CENTER)
        ));
        return title;
    }
    ...
    private Widget section(String title, Widget content) {
        ...
        card.useStyle(UIStyle.of(
                padding(8),
                background(new ColorTexture(0x40222830))
        ));
    ...
    private Widget styledRuns() {
        return RichTextWidget.of(
                RichText.builder()
                        .text("plain ").color(0xFFCCCCCC)
                        .text("rgb ").color(0xFF6699FF)
                        .bold().text("bold ").italic().text("bold-italic ")
                        .clearStyle().underlined().text("underline ")
                        .strikethrough().text("strike ")
                        .clearStyle().obfuscated().text("magic ").clearStyle()
                        .shadow(true).text("shadow ").clearStyle()
                        .highlight(0x6633CC55).text("highlight").clearStyle()
                        .newline()
                        .text("vanilla component: ").color(0xFF999999)
                        .component(Component.literal("styled component")
    ...
    private Widget localization() {
        ...
        column.addWidget(RichTextWidget.of(
                RichText.builder()
        ...
        column.addWidget(RichTextWidget.of(
                RichText.builder()
                        .translatable("chat.type.advancement.task",
                                "Alex",
        ...
        column.addWidget(RichTextWidget.of(
                RichText.builder()
                        .text("missing key: ").color(0xFF888888)
                        .translatable("cloudlib.demo.missing.key")
                        .build()
        ));
        return column;
    }
    ...
    private Widget inlineMedia() {
        ...
        column.addWidget(RichTextWidget.of(
                RichText.builder()
                        .text("icons ").color(0xFFCCCCCC)
                        .image(ImageTexture.of(ResourceLocation.withDefaultNamespace("textures/item/diamond.png"), 16, 16))
                        .text(" ")
                        .image(ImageTexture.of(ResourceLocation.withDefaultNamespace("textures/item/golden_apple.png"), 16, 16))
                        .text(" items ").color(0xFFCCCCCC)
                        .item(new ItemStack(Items.DIAMOND_SWORD), 16, true)
                        .text(" ")
                        .item(new ItemStack(Items.TNT, 42), 16, true)
                        .text(" scaled-up ").color(0xFFCCCCCC)
                        .item(new ItemStack(Items.RECOVERY_COMPASS), 24, false)
                        .build()
        ));
        column.addWidget(RichTextWidget.of(
                RichText.builder()
                        .text("blocks ").color(0xFFCCCCCC)
                        .block(Blocks.GRASS_BLOCK.defaultBlockState(), 20)
                        .text(" ")
                        .block(Blocks.FURNACE.defaultBlockState(), 20)
                        .text(" ")
                        .block(Blocks.CRAFTING_TABLE.defaultBlockState(), 20)
                        .text(" ")
                        .block(Blocks.REDSTONE_LAMP.defaultBlockState(), 20)
                        .text(" padded ").color(0xFFCCCCCC)
                        .padding(Insets.uniform(4))
                        .block(Blocks.BEACON.defaultBlockState(), 16)
                        .clearStyle()
                        .build()
        ));
        ...
        column.addWidget(RichTextWidget.of(
                RichText.builder()
                        ...
                        .append(new CustomRenderNode(80, 14, (canvas, x, y, w, h) -> {
                            ...
                            canvas.roundedRect((int) x, (int) y, (int) w, (int) h, 6f, 0xFF000000 | r << 16 | g << 8 | b);
                        }))
                        .text(" <- animated CustomRenderNode").color(0xFF888888)
                        .build()
        ));
        return column;
    }
    ...
    private Widget entities() {
        ...
        return RichTextWidget.of(
                RichText.builder()
                        .text("pig follows mouse ").color(0xFFCCCCCC)
                        .entity(() -> new Pig(EntityType.PIG, Minecraft.getInstance().level),
                                24, 30, 14, true)
                        .text(" zombie static ").color(0xFFCCCCCC)
                        .entity(() -> new Zombie(EntityType.ZOMBIE, Minecraft.getInstance().level),
                                24, 30, 14, false)
                        .build()
        );
    }
    ...
    private Widget interactive() {
        ...
        column.addWidget(RichTextWidget.of(
                RichText.builder()
                        .text("[+1]").color(ChatFormatting.GREEN).bold()
                        .onClickLast(ClickAction.run(() -> clickCount++))
                        .onHoverLast(HoverAction.text(Component.literal("Increments the footer counter")))
                        .text("  ")
                        .text("[copy]").color(ChatFormatting.YELLOW)
                        .onClickLast(ClickAction.copyToClipboard("CloudLib rich text demo"))
                        .onHoverLast(HoverAction.text(Component.literal("Copies text to your clipboard")))
                        .text("  ")
                        .text("[link]").color(ChatFormatting.BLUE).underlined()
                        .onClickLast(ClickAction.openUrl("https://github.com"))
                        .text("  ")
                        .text("[vanilla click event]").color(ChatFormatting.LIGHT_PURPLE)
                        .onClickLast(ClickAction.vanilla(new ClickEvent(ClickEvent.Action.COPY_TO_CLIPBOARD, "copied via vanilla ClickEvent")))
                        .build()
        ));
        // Hover with a full CloudLib tooltip
        var richTooltip = Tooltip.create()
                .add(Component.literal("Rich hover tooltip").withStyle(ChatFormatting.GOLD), Tooltip.title)
                .add(RichText.builder()
                        .text("inline items work here too ")
                        .item(new ItemStack(Items.DIAMOND), 12, false)
                        .build());
        column.addWidget(RichTextWidget.of(
                RichText.builder()
                        .text("[hover for rich tooltip]").color(0xFF55FFFF)
                        .onHoverLast(HoverAction.tooltip(richTooltip))
                        .build()
        ));
        return column;
    }
    ...
    private Widget embeddedWidgets() {
        var button = ButtonWidget.of("+10", () -> clickCount += 10)
        ...
        return RichTextWidget.of(
                RichText.builder()
                        .text("a button ").color(0xFFCCCCCC)
                        .append(new WidgetNode(button, 40, 16))
                        .text(" and a toggle ").color(0xFFCCCCCC)
                        .append(new WidgetNode(toggle, 30, 12))
                        .text(" live inside the text flow").color(0xFF888888)
                        .build()
        );
    }
    ...
    private Widget alignmentAndWrapping() {
        ...
        var paragraph = RichTextWidget.of(
                RichText.builder()
                        .color(0xFFCCCCCC)
                        .text("A longer paragraph wraps at the imposed width. ")
                        .color(ChatFormatting.GOLD).text("Styles carry across line breaks, ")
                        .color(0xFFCCCCCC).text("and inline objects like ")
                        .item(new ItemStack(Items.BOOK), 12, false)
                        .text(" flow with the words.")
                        .build()
        );
        paragraph.useStyle(UIStyle.of(widthOf(240), background(new ColorTexture(0x20FFFFFF))));
        column.addWidget(paragraph);

        for (var align : new dev.vfyjxf.taffy.style.TextAlign[]{
                dev.vfyjxf.taffy.style.TextAlign.LEFT,
                dev.vfyjxf.taffy.style.TextAlign.CENTER,
                dev.vfyjxf.taffy.style.TextAlign.RIGHT}) {
            var aligned = RichTextWidget.of(RichText.of("text-align: " + align));
            aligned.useStyle(UIStyle.of(
                    widthOf(240),
                    textAlign(align),
                    background(new ColorTexture(0x20FFFFFF))
            ));
        ...
        column.addWidget(RichTextWidget.of(
                RichText.builder()
                        .text("valign ").color(0xFFCCCCCC)
                        .item(new ItemStack(Items.ARROW), 16, false)
                        .text(" baseline / ").color(0xFF888888)
                        .verticalAlign(VerticalAlign.TOP)
                        .item(new ItemStack(Items.ARROW), 16, false)
                        .text(" top / ").color(0xFF888888)
                        .verticalAlign(VerticalAlign.MIDDLE)
                        .item(new ItemStack(Items.ARROW), 16, false)
                        .text(" middle").color(0xFF888888)
                        .build()
        ));
        return column;
    }
    ...
    private Widget richTooltip() {
        var label = LabelWidget.of("hover this label → tooltip with item + styled text")
                               .setColor(0xFF88CCFF);
        label.setTooltip(Tooltip.create()
                .add(Component.literal("Rich tooltip").withStyle(ChatFormatting.GOLD, ChatFormatting.BOLD), Tooltip.title)
                .add(Component.literal("plain line").withStyle(ChatFormatting.GRAY))
                .add(RichText.builder()
                        .text("crafted from ")
                        .item(new ItemStack(Items.DIAMOND, 3), 12, true)
                        .text(" + ")
                        .block(Blocks.CRAFTING_TABLE.defaultBlockState(), 12)
                        .build()));
        return label;
    }
}
