...
public class NineSliceTexture implements RenderableBoundTexture {
    ...
    public NineSliceTexture(SpriteUploader spriteUploader, ResourceLocation location, int width, int height, int left, int right, int top, int bottom) {
